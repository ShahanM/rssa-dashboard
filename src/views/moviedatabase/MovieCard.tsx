...
const MovieCard = ({
	movie, onClick, isSelected
}: { movie: MovieDetails; onClick: () => void; isSelected: boolean }) => (
	<div
		onClick={onClick}
		className={clsx(
	...
	>
		<img
			...
			onError={(e) => { e.currentTarget.src = 'https://placehold.co/400x600/000000/FFFFFF?text=No+Image'; }}
		/>
