...
const MovieDatabase: React.FC = () => {
    ...
    const queryParams = {
        ...
        exclude_no_emotions: filters.excludeNoEmotions || undefined,
        exclude_no_recommendations: filters.excludeNoRecommendations || undefined,
    };
    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-900 dark:text-gray-100">
            <main className="container mx-auto p-4">
                ...
                <PaginatedResourceViewer<MovieDetails> apiResourceTag="movies" limit={15} queryParams={queryParams}>
                    {(movies, selectedItem, handleItemClick) => (
                        <div className="flex gap-6">
                            ...
                            <div
                                className={clsx('transition-all duration-500 ease-in-out transform', {
