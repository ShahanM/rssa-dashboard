...
import { StudyNavigationProvider, useStudyNavigation } from '../../hooks/StudyNavigationContext';
...
const Study: React.FC = () => (
	<StudyNavigationProvider>
		<StudyContent />
	</StudyNavigationProvider>
);

export default withAuthenticationRequired(Study, {
